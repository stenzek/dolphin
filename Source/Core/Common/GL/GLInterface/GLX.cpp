...
bool cInterfaceGLX::Create(void* window_handle, bool stereo, bool core)
{
  ...
  std::array<int, 9> context_attribs = {GLX_CONTEXT_MAJOR_VERSION_ARB,
                                        4,
  ...
  {
    std::array<int, 9> context_attribs_33 = {GLX_CONTEXT_MAJOR_VERSION_ARB,
                                             3,
                                             GLX_CONTEXT_MINOR_VERSION_ARB,
                                             3,
                                             GLX_CONTEXT_PROFILE_MASK_ARB,
  ...
  if (!ctx || s_glxError)
  {
    std::array<int, 5> context_attribs_legacy = {GLX_CONTEXT_MAJOR_VERSION_ARB, 1,
