...
private:
  ...
  enum DITRY_FLAG : u32
  {
    ...
    DIRTY_FLAG_UBER_UBO = (1 << 3),
    DIRTY_FLAG_PS_SAMPLERS = (1 << 4),
    DIRTY_FLAG_PS_SSBO = (1 << 5),
    DIRTY_FLAG_DYNAMIC_OFFSETS = (1 << 6),
    DIRTY_FLAG_VERTEX_BUFFER = (1 << 7),
    DIRTY_FLAG_INDEX_BUFFER = (1 << 8),
    DIRTY_FLAG_VIEWPORT = (1 << 9),
    DIRTY_FLAG_SCISSOR = (1 << 10),
    DIRTY_FLAG_PIPELINE = (1 << 11),
    DIRTY_FLAG_DESCRIPTOR_SET_BINDING = (1 << 12),
    DIRTY_FLAG_PIPELINE_BINDING = (1 << 13),

    DIRTY_FLAG_ALL_DESCRIPTOR_SETS = DIRTY_FLAG_VS_UBO | DIRTY_FLAG_GS_UBO | DIRTY_FLAG_PS_UBO |
                                     DIRTY_FLAG_UBER_UBO | DIRTY_FLAG_PS_SAMPLERS |
                                     DIRTY_FLAG_PS_SSBO
  };
