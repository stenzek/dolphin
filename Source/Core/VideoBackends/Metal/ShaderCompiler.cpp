                        ...
                        size_t source_code_length)
{
  ...
  {
    return CompileShaderToSPV(out_code, stage, source_code, source_code_length,
...
bool TranslateSPVToMSL(std::string* out_msl, ShaderStage stage, const SPIRVCodeVector* in_spv)
{
  ...
  spirv_cross::CompilerMSL compiler(in_spv->data(), in_spv->size(), nullptr, 0, resource_bindings, ArraySize(resource_bindings));
